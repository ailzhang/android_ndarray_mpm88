...
void main()
{
    ...
    for (int tmp3_i32 = _21; tmp3_i32 < 213444; )
    {
        ...
        int tmp4372_i32 = tmp109_i32 - (462 * (tmp109_i32 / 462));
        int tmp4595_i32 = (tmp106_i32 - (462 * (tmp106_i32 / 462))) * 462;
        uint _199 = uint(tmp4372_i32 + tmp4595_i32) * 8u;
        float tmp111_f32 = uintBitsToFloat(root_buffer_0_u32._m0[(3415104u + _199) >> 2u]);
        uint _209 = root_buffer_0_u32._m0[(_199 + 3415108u) >> 2u];
        float tmp113_f32 = uintBitsToFloat(_209);
        int tmp118_i32 = max(0, min(461, int(tmp98_f32 + 1.5)));
        int tmp4611_i32 = (tmp118_i32 - (462 * (tmp118_i32 / 462))) * 462;
        uint _222 = uint(tmp4372_i32 + tmp4611_i32) * 8u;
        uint _232 = root_buffer_0_u32._m0[(_222 + 3415108u) >> 2u];
        int tmp126_i32 = max(0, min(461, int(tmp100_f32 + 1.5)));
        int tmp4444_i32 = tmp126_i32 - (462 * (tmp126_i32 / 462));
        uint _243 = uint(tmp4444_i32 + tmp4595_i32) * 8u;
        float tmp128_f32 = uintBitsToFloat(root_buffer_0_u32._m0[(3415104u + _243) >> 2u]);
        uint _253 = root_buffer_0_u32._m0[(_243 + 3415108u) >> 2u];
        float tmp130_f32 = uintBitsToFloat(_253);
        uint _257 = uint(tmp4444_i32 + tmp4611_i32) * 8u;
        uint _267 = root_buffer_0_u32._m0[(_257 + 3415108u) >> 2u];
        float tmp139_f32 = tmp111_f32 + (tmp99_f32 * (uintBitsToFloat(root_buffer_0_u32._m0[(3415104u + _222) >> 2u]) - tmp111_f32));
        float tmp140_f32 = tmp113_f32 + (tmp99_f32 * (uintBitsToFloat(_232) - tmp113_f32));
        root_buffer_0_u32._m0[(1707552u + _70) >> 2u] = floatBitsToUint(tmp139_f32 + (tmp101_f32 * ((tmp128_f32 + (tmp99_f32 * (uintBitsToFloat(root_buffer_0_u32._m0[(3415104u + _257) >> 2u]) - tmp128_f32))) - tmp139_f32)));
        root_buffer_0_u32._m0[(_70 + 1707556u) >> 2u] = floatBitsToUint(tmp140_f32 + (tmp101_f32 * ((tmp130_f32 + (tmp99_f32 * (uintBitsToFloat(_267) - tmp130_f32))) - tmp140_f32)));
