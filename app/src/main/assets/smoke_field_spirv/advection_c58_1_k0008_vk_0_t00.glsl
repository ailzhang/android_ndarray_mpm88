...
void main()
{
    ...
    for (int tmp3_i32 = _21; tmp3_i32 < 53361; )
    {
        ...
        int tmp4376_i32 = tmp109_i32 - (231 * (tmp109_i32 / 231));
        int tmp4599_i32 = (tmp106_i32 - (231 * (tmp106_i32 / 231))) * 231;
        uint _199 = uint(tmp4376_i32 + tmp4599_i32) * 8u;
        float tmp111_f32 = uintBitsToFloat(root_buffer_0_u32._m0[(853776u + _199) >> 2u]);
        uint _209 = root_buffer_0_u32._m0[(_199 + 853780u) >> 2u];
        float tmp113_f32 = uintBitsToFloat(_209);
        int tmp118_i32 = max(0, min(230, int(tmp98_f32 + 1.5)));
        int tmp4615_i32 = (tmp118_i32 - (231 * (tmp118_i32 / 231))) * 231;
        uint _222 = uint(tmp4376_i32 + tmp4615_i32) * 8u;
        uint _232 = root_buffer_0_u32._m0[(_222 + 853780u) >> 2u];
        int tmp126_i32 = max(0, min(230, int(tmp100_f32 + 1.5)));
        int tmp4448_i32 = tmp126_i32 - (231 * (tmp126_i32 / 231));
        uint _243 = uint(tmp4448_i32 + tmp4599_i32) * 8u;
        float tmp128_f32 = uintBitsToFloat(root_buffer_0_u32._m0[(853776u + _243) >> 2u]);
        uint _253 = root_buffer_0_u32._m0[(_243 + 853780u) >> 2u];
        float tmp130_f32 = uintBitsToFloat(_253);
        uint _257 = uint(tmp4448_i32 + tmp4615_i32) * 8u;
        uint _267 = root_buffer_0_u32._m0[(_257 + 853780u) >> 2u];
        float tmp139_f32 = tmp111_f32 + (tmp99_f32 * (uintBitsToFloat(root_buffer_0_u32._m0[(853776u + _222) >> 2u]) - tmp111_f32));
        float tmp140_f32 = tmp113_f32 + (tmp99_f32 * (uintBitsToFloat(_232) - tmp113_f32));
        root_buffer_0_u32._m0[(426888u + _70) >> 2u] = floatBitsToUint(tmp139_f32 + (tmp101_f32 * ((tmp128_f32 + (tmp99_f32 * (uintBitsToFloat(root_buffer_0_u32._m0[(853776u + _257) >> 2u]) - tmp128_f32))) - tmp139_f32)));
        root_buffer_0_u32._m0[(_70 + 426892u) >> 2u] = floatBitsToUint(tmp140_f32 + (tmp101_f32 * ((tmp130_f32 + (tmp99_f32 * (uintBitsToFloat(_267) - tmp130_f32))) - tmp140_f32)));
