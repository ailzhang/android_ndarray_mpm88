...
void main()
{
    ...
    for (int tmp3_i32 = _21; tmp3_i32 < 213444; )
    {
        ...
        uint _70 = _68 * 8u;
        uint _81 = root_buffer_0_u32._m0[(3415104u + _70) >> 2u];
        float tmp33_f32 = uintBitsToFloat(_81);
        uint _87 = root_buffer_0_u32._m0[(_70 + 3415108u) >> 2u];
        ...
        uint _115 = root_buffer_0_u32._m0[(3415104u + _110) >> 2u];
        uint _120 = root_buffer_0_u32._m0[(_110 + 3415108u) >> 2u];
        ...
        uint _147 = root_buffer_0_u32._m0[(3415104u + _142) >> 2u];
        uint _152 = root_buffer_0_u32._m0[(_142 + 3415108u) >> 2u];
        ...
        int tmp7698_i32 = tmp109_i32 - (462 * (tmp109_i32 / 462));
        int tmp8011_i32 = (tmp106_i32 - (462 * (tmp106_i32 / 462))) * 462;
        uint _202 = uint(tmp7698_i32 + tmp8011_i32) * 12u;
        float tmp111_f32 = uintBitsToFloat(root_buffer_0_u32._m0[(8537760u + _202) >> 2u]);
        uint _212 = root_buffer_0_u32._m0[(_202 + 8537764u) >> 2u];
        float tmp113_f32 = uintBitsToFloat(_212);
        uint _217 = root_buffer_0_u32._m0[(_202 + 8537768u) >> 2u];
        float tmp115_f32 = uintBitsToFloat(_217);
        int tmp120_i32 = max(0, min(461, int(tmp98_f32 + 1.5)));
        int tmp8035_i32 = (tmp120_i32 - (462 * (tmp120_i32 / 462))) * 462;
        uint _230 = uint(tmp7698_i32 + tmp8035_i32) * 12u;
        uint _240 = root_buffer_0_u32._m0[(_230 + 8537764u) >> 2u];
        uint _245 = root_buffer_0_u32._m0[(_230 + 8537768u) >> 2u];
        int tmp130_i32 = max(0, min(461, int(tmp100_f32 + 1.5)));
        int tmp7806_i32 = tmp130_i32 - (462 * (tmp130_i32 / 462));
        uint _256 = uint(tmp7806_i32 + tmp8011_i32) * 12u;
        float tmp132_f32 = uintBitsToFloat(root_buffer_0_u32._m0[(8537760u + _256) >> 2u]);
        uint _266 = root_buffer_0_u32._m0[(_256 + 8537764u) >> 2u];
        float tmp134_f32 = uintBitsToFloat(_266);
        uint _271 = root_buffer_0_u32._m0[(_256 + 8537768u) >> 2u];
        float tmp136_f32 = uintBitsToFloat(_271);
        uint _275 = uint(tmp7806_i32 + tmp8035_i32) * 12u;
        uint _285 = root_buffer_0_u32._m0[(_275 + 8537764u) >> 2u];
        uint _290 = root_buffer_0_u32._m0[(_275 + 8537768u) >> 2u];
        float tmp149_f32 = tmp111_f32 + (tmp99_f32 * (uintBitsToFloat(root_buffer_0_u32._m0[(8537760u + _230) >> 2u]) - tmp111_f32));
        ...
        uint _322 = _68 * 12u;
        root_buffer_0_u32._m0[(5976432u + _322) >> 2u] = floatBitsToUint(tmp149_f32 + (tmp101_f32 * ((tmp132_f32 + (tmp99_f32 * (uintBitsToFloat(root_buffer_0_u32._m0[(8537760u + _275) >> 2u]) - tmp132_f32))) - tmp149_f32)));
        root_buffer_0_u32._m0[(_322 + 5976436u) >> 2u] = floatBitsToUint(tmp150_f32 + (tmp101_f32 * ((tmp134_f32 + (tmp99_f32 * (uintBitsToFloat(_285) - tmp134_f32))) - tmp150_f32)));
        root_buffer_0_u32._m0[(_322 + 5976440u) >> 2u] = floatBitsToUint(tmp151_f32 + (tmp101_f32 * ((tmp136_f32 + (tmp99_f32 * (uintBitsToFloat(_290) - tmp136_f32))) - tmp151_f32)));
