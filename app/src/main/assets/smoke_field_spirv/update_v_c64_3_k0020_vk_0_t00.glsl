...
void main()
{
    ...
    for (int tmp3_i32 = _21; tmp3_i32 < 53361; tmp3_i32 += total_invocs)
    {
        ...
        int tmp12832_i32 = tmp35_i32 - (231 * (tmp35_i32 / 231));
        int tmp40_i32 = max(0, min(230, (tmp12_i32 + 1)));
        int tmp45_i32 = max(0, min(230, tmp12_i32));
        int tmp47_i32 = max(0, min(230, (tmp17_i32 + (-1))));
        int tmp12999_i32 = (tmp45_i32 - (231 * (tmp45_i32 / 231))) * 231;
        uint _125 = root_buffer_0_u32._m0[(uint((tmp47_i32 - (231 * (tmp47_i32 / 231))) + tmp12999_i32) * 4u) >> 2u];
        int tmp52_i32 = max(0, min(230, (tmp17_i32 + 1)));
        uint _140 = root_buffer_0_u32._m0[(uint((tmp52_i32 - (231 * (tmp52_i32 / 231))) + tmp12999_i32) * 4u) >> 2u];
        uint _152 = uint(tmp12832_i32 + tmp12999_i32) * 8u;
        float tmp62_f32 = uintBitsToFloat(root_buffer_0_u32._m0[(853776u + _152) >> 2u]) - ((uintBitsToFloat(root_buffer_0_u32._m0[(uint(tmp12832_i32 + ((tmp40_i32 - (231 * (tmp40_i32 / 231))) * 231)) * 4u) >> 2u]) - uintBitsToFloat(root_buffer_0_u32._m0[(uint(tmp12832_i32 + ((tmp33_i32 - (231 * (tmp33_i32 / 231))) * 231)) * 4u) >> 2u])) * 0.5);
        uint _163 = root_buffer_0_u32._m0[(_152 + 853780u) >> 2u];
        ...
        root_buffer_0_u32._m0[(853776u + _251) >> 2u] = floatBitsToUint(_264);
        root_buffer_0_u32._m0[(_251 + 853780u) >> 2u] = floatBitsToUint(_192 ? 0.0 : tmp65_f32);
    }
}
