...
void main()
{
    ...
    for (int tmp3_i32 = _21; tmp3_i32 < 53361; )
    {
        ...
        int tmp5974_i32 = tmp109_i32 - (231 * (tmp109_i32 / 231));
        int tmp6287_i32 = (tmp106_i32 - (231 * (tmp106_i32 / 231))) * 231;
        uint _202 = uint(tmp5974_i32 + tmp6287_i32) * 12u;
        float tmp111_f32 = uintBitsToFloat(root_buffer_0_u32._m0[(1494108u + _202) >> 2u]);
        uint _212 = root_buffer_0_u32._m0[(_202 + 1494112u) >> 2u];
        float tmp113_f32 = uintBitsToFloat(_212);
        uint _217 = root_buffer_0_u32._m0[(_202 + 1494116u) >> 2u];
        float tmp115_f32 = uintBitsToFloat(_217);
        int tmp120_i32 = max(0, min(230, int(tmp98_f32 + 1.5)));
        int tmp6311_i32 = (tmp120_i32 - (231 * (tmp120_i32 / 231))) * 231;
        uint _230 = uint(tmp5974_i32 + tmp6311_i32) * 12u;
        uint _240 = root_buffer_0_u32._m0[(_230 + 1494112u) >> 2u];
        uint _245 = root_buffer_0_u32._m0[(_230 + 1494116u) >> 2u];
        int tmp130_i32 = max(0, min(230, int(tmp100_f32 + 1.5)));
        int tmp6082_i32 = tmp130_i32 - (231 * (tmp130_i32 / 231));
        uint _256 = uint(tmp6082_i32 + tmp6287_i32) * 12u;
        float tmp132_f32 = uintBitsToFloat(root_buffer_0_u32._m0[(1494108u + _256) >> 2u]);
        uint _266 = root_buffer_0_u32._m0[(_256 + 1494112u) >> 2u];
        float tmp134_f32 = uintBitsToFloat(_266);
        uint _271 = root_buffer_0_u32._m0[(_256 + 1494116u) >> 2u];
        float tmp136_f32 = uintBitsToFloat(_271);
        uint _275 = uint(tmp6082_i32 + tmp6311_i32) * 12u;
        uint _285 = root_buffer_0_u32._m0[(_275 + 1494112u) >> 2u];
        uint _290 = root_buffer_0_u32._m0[(_275 + 1494116u) >> 2u];
        float tmp149_f32 = tmp111_f32 + (tmp99_f32 * (uintBitsToFloat(root_buffer_0_u32._m0[(1494108u + _230) >> 2u]) - tmp111_f32));
        ...
        uint _322 = _68 * 12u;
        root_buffer_0_u32._m0[(2134440u + _322) >> 2u] = floatBitsToUint(tmp149_f32 + (tmp101_f32 * ((tmp132_f32 + (tmp99_f32 * (uintBitsToFloat(root_buffer_0_u32._m0[(1494108u + _275) >> 2u]) - tmp132_f32))) - tmp149_f32)));
        root_buffer_0_u32._m0[(_322 + 2134444u) >> 2u] = floatBitsToUint(tmp150_f32 + (tmp101_f32 * ((tmp134_f32 + (tmp99_f32 * (uintBitsToFloat(_285) - tmp134_f32))) - tmp150_f32)));
        root_buffer_0_u32._m0[(_322 + 2134448u) >> 2u] = floatBitsToUint(tmp151_f32 + (tmp101_f32 * ((tmp136_f32 + (tmp99_f32 * (uintBitsToFloat(_290) - tmp136_f32))) - tmp151_f32)));
