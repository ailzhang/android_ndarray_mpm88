...
void main()
{
    ...
    for (int tmp3_i32 = _21; tmp3_i32 < 213444; tmp3_i32 += total_invocs)
    {
        ...
        int tmp11953_i32 = tmp35_i32 - (462 * (tmp35_i32 / 462));
        int tmp40_i32 = max(0, min(461, (tmp12_i32 + 1)));
        int tmp45_i32 = max(0, min(461, tmp12_i32));
        int tmp47_i32 = max(0, min(461, (tmp17_i32 + (-1))));
        int tmp12120_i32 = (tmp45_i32 - (462 * (tmp45_i32 / 462))) * 462;
        uint _126 = root_buffer_0_u32._m0[(853776u + (uint((tmp47_i32 - (462 * (tmp47_i32 / 462))) + tmp12120_i32) * 4u)) >> 2u];
        int tmp52_i32 = max(0, min(461, (tmp17_i32 + 1)));
        uint _141 = root_buffer_0_u32._m0[(853776u + (uint((tmp52_i32 - (462 * (tmp52_i32 / 462))) + tmp12120_i32) * 4u)) >> 2u];
        uint _153 = uint(tmp11953_i32 + tmp12120_i32) * 8u;
        float tmp62_f32 = uintBitsToFloat(root_buffer_0_u32._m0[(1707552u + _153) >> 2u]) - ((uintBitsToFloat(root_buffer_0_u32._m0[(853776u + (uint(tmp11953_i32 + ((tmp40_i32 - (462 * (tmp40_i32 / 462))) * 462)) * 4u)) >> 2u]) - uintBitsToFloat(root_buffer_0_u32._m0[(853776u + (uint(tmp11953_i32 + ((tmp33_i32 - (462 * (tmp33_i32 / 462))) * 462)) * 4u)) >> 2u])) * 0.5);
        uint _164 = root_buffer_0_u32._m0[(_153 + 1707556u) >> 2u];
        ...
        root_buffer_0_u32._m0[(1707552u + _250) >> 2u] = floatBitsToUint(_263);
        root_buffer_0_u32._m0[(_250 + 1707556u) >> 2u] = floatBitsToUint(_191 ? 0.0 : tmp65_f32);
    }
}
